...
TAlEncESPRIExample::TAlEncESPRIExample()
  : TAlEncSub(), ESPRIparameters(0), ESPRIUserPara(0), fCalibESPRI_NaI(0),  fCalibESPRI_tdc(0),  fCalibESPRI_rdc(0),  fCalibESPRI_bdc(0),  fCalibESPRI_fadc(0),  fCalibESPRI_plas(0),
