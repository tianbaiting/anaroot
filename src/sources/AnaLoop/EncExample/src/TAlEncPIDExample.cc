...
void TAlEncPIDExample::Construct()
{
  ...
  tof_f3pl_f5pl2 = (TArtTOF*)recotof->FindTOF((char*)"F3pl",(char*)"F5pl-2");
  tof_f3pl_f7pl = (TArtTOF*)recotof->FindTOF((char*)"F3pl",(char*)"F7pl");
  tof_f3pl_f8pl = (TArtTOF*)recotof->FindTOF((char*)"F3pl",(char*)"F8pl");
  tof_f5pl2_f7pl = (TArtTOF*)recotof->FindTOF((char*)"F5pl-2",(char*)"F7pl");
  tof_f7pl_f8pl = (TArtTOF*)recotof->FindTOF((char*)"F7pl",(char*)"F8pl");
  tof_f7pl_f11pl = (TArtTOF*)recotof->FindTOF((char*)"F7pl",(char*)"F11pl-1");
  tof_f8pl_f9ppac = NULL;
  tof_f8pl_f11pl = (TArtTOF*)recotof->FindTOF((char*)"F8pl",(char*)"F11pl-1");

  recobeam = new TArtRecoBeam;
  beam_rips3to5_ic7_beta3to5 = (TArtBeam*)recobeam->FindBeam(3,5,(char*)"F3pl",(char*)"F5pl-2",(char*)"F7IC");
  beam_rips5to7_ic7_beta5to7 = (TArtBeam*)recobeam->FindBeam(5,7,(char*)"F5pl-2",(char*)"F7pl",(char*)"F7IC");
  beam_rips3to5_ic7_beta3to7 = (TArtBeam*)recobeam->FindBeam(3,5,(char*)"F3pl",(char*)"F7pl",(char*)"F7IC");
  beam_rips5to7_ic7_beta3to7 = (TArtBeam*)recobeam->FindBeam(5,7,(char*)"F3pl",(char*)"F7pl",(char*)"F7IC");

  beam_rips8to9_ic11_beta8to11 = (TArtBeam*)recobeam->FindBeam(8,9,(char*)"F8pl",(char*)"F11pl-1",(char*)"F11IC");
  beam_rips9to11_ic11_beta8to11 = (TArtBeam*)recobeam->FindBeam(9,11,(char*)"F8pl",(char*)"F11pl-1",(char*)"F11IC");
  beam_rips10to11_ic11_beta7to11 = (TArtBeam*)recobeam->FindBeam(10,11,(char*)"F7pl",(char*)"F11pl-1",(char*)"F11IC");
  beam_rips8to9_ic11_beta7to11 = (TArtBeam*)recobeam->FindBeam(8,9,(char*)"F7pl",(char*)"F11pl-1",(char*)"F11IC");
  beam_rips9to11_ic11_beta7to11 = (TArtBeam*)recobeam->FindBeam(9,11,(char*)"F7pl",(char*)"F11pl-1",(char*)"F11IC");
