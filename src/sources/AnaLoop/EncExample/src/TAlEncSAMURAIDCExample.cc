...
TAlEncSAMURAIDCExample::TAlEncSAMURAIDCExample()
  : TAlEncSub(), samuraiparameters(0), fCalibBPCHit(0), fCalibBDC1Hit(0), fCalibBDC2Hit(0), fCalibFDC0Hit(0), fCalibFDC1Hit(0), fCalibFDC2Hit(0), fCalibPDCHit(0), fCalibBDC1Track(0), fCalibBDC2Track(0), fCalibFDC0Track(0), fCalibFDC1Track(0), fCalibFDC2Track(0), fCalibPDCTrack(0)
{;}
