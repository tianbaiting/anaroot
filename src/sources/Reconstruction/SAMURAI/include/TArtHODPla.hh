...
class TArtHODPla : public TArtDataObject {
 ...
 public:
  ...
  virtual void Copy(TArtHODPla& hit) const {
    TArtHODPla &obj = *(TArtHODPla*) &hit;
    ...
    obj.SetQUCal(fQUCal);
    obj.SetQDCal(fQDCal);
    obj.SetQAveRaw(fQAveRaw);
    obj.SetQAvePed(fQAvePed);
    obj.SetQAveCal(fQAveCal);
    obj.SetTime(fTime);
    obj.SetTimeU(fTimeU);
    obj.SetTimeD(fTimeD);
    obj.SetTimeUSlew(fTimeUSlew);
    obj.SetTimeDSlew(fTimeDSlew);
    obj.SetTimeSlew(fTimeSlew);
