...
void TArtCalibBLD::ReconstructData()  {
  ...
  Int_t tdc[4]={0,0,0,0};
  Double_t drft1,drft2,drft3,drft4,drft[4]={0,0,0,0};
  Double_t xx[4],dxx[4];
  //  Double_t init_x=0,xerr=0,aerr=0;
  Double_t xtrue=0,atrue=0;
  //  Double_t init_y=0,yerr=0,berr=0;
  Double_t ytrue=0,btrue=0;
  Double_t pi=0,d2r=0;
  ...
  */
  ...
  Int_t narray=0;
  Double_t chi, chimax=99999., xout[4]={0,0,0,0};
