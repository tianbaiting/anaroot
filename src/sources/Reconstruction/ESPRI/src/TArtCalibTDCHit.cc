...
void TArtCalibTDCHit::LoadData()   {
  ...
  for(Int_t i=0;i<fEvent->GetNumSeg();i++){
    ...
    if(
       ((fpl == 12) && (3 == detector || 2 == detector || 54 == detector || 56 == detector || 19 == detector)) ||
       ((fpl ==  0) && ((1<=detector && detector<=6) || (detector==10)))
       ){//ESPRI2016withESPRI03withBLD
      LoadData(seg);
...
void TArtCalibTDCHit::LoadData(TArtRawSegmentObject *seg)   {
  ...
  if(((fpl == 12) && (3 == detector || 2 == detector || 54 == detector || 56 == detector || 19 == detector)) ||
     ((fpl ==  0) && (((1<=detector) && (detector<=6)) || (detector==10))) ){//ESPRI2016withESPRI03withBLD
