...
void TArtCalibRDC::ReconstructData()  {
  ...
  Double_t drft1=0,drft2=0,drft3=0,drft4=0,drft[4]={0,0,0,0};
  //Double_t xx[7],dxx[7];
  Double_t dxx[7] = {0,0,0,0,0,0,0};
  //Double_t ang=-9999,init_x=-9999,xerr=-9999,aerr=-9999;
  Double_t xtrue=-9999,atrue=-9999;
  ...
  */
  ...
  (void) tww; // to avoid warning as this is unused
  /*
