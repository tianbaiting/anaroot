...
class TArtBLD : public TArtDataObject {
 ...
 public:
  ...
  void  SetBLDX(Double_t val){fBX = val;}
  void  SetBLDY(Double_t val){fBY = val;}
  void  SetBLDA(Double_t val){fBA = val;}
  void  SetBLDB(Double_t val){fBB = val;}
  void  SetCHI2(Double_t val){fCHI= val;}
  void  SetLayer(Int_t val) {layer= val;}
  Double_t  GetBLDX(){return fBX;}
  Double_t  GetBLDY(){return fBY;}
  Double_t  GetBLDA(){return fBA;}
  Double_t  GetBLDB(){return fBB;}
