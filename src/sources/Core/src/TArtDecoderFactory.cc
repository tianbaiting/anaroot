...
{
   Register(TArtDecoderFIT::Instance());
   ...
   Register(TArtDecoderMQDC32::Instance());
   Register(TArtDecoderMTDC32::Instance());
   Register(TArtDecoderMDPP16::Instance());
   ...
   /**** HJKT ****/
   Register(TArtDecoderRICHADCM::Instance());
