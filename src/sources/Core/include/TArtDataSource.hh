...
public:
  ...
  virtual bool SMOpen(const int){return false;}
  //  virtual bool FileOpen(const char* sourceName=0){return false;}
  virtual bool FileOpen(const char*){return false;}
  virtual bool SocketOpen(const char*, const int, const bool){return false;}
